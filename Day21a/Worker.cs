...
public class Worker : IWorker
{
    ...
    List<string> GenerateSequences((char c, int count) horizontal, (char c, int count) vertical)
    {
        ...
        //     {
        //         var sequence = new string(Enumerable.Repeat(vertical.c, i).Concat(Enumerable.Repeat(horizontal.c, 1)).Concat(Enumerable.Repeat(vertical.c, vertical.count - i)).ToArray());
        ...
        //     {
        //         var sequence = new string(Enumerable.Repeat(horizontal.c, i).Concat(Enumerable.Repeat(vertical.c, 1)).Concat(Enumerable.Repeat(horizontal.c, horizontal.count - i)).ToArray());
        //         sequences.Add(sequence);
        //     }
        // }
        // else if (horizontal.count == 2 && vertical.count == 2)
        // {
        ...
        //                 Enumerable.Repeat(vertical.c, i1)
        //                 .Concat(Enumerable.Repeat(horizontal.c, 1))
        //                 .Concat(Enumerable.Repeat(vertical.c, i2 - i1 - 1))
        //                 .Concat(Enumerable.Repeat(horizontal.c, 1))
        //                 .Concat(Enumerable.Repeat(vertical.c, 3 - i2)).ToArray());
        //             sequences.Add(sequence);
        //         }
        //     }
        // }
